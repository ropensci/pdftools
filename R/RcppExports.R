...
poppler_convert <- function(x, format, pages, names, dpi, opw, upw, verbose = TRUE) {
    .Call('_pdftools_poppler_convert', PACKAGE = 'pdftools', x, format, pages, names, dpi, opw, upw, verbose)
}
